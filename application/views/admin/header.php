				...
				<div class="navbar-header" data-logobg="skin5">
					...
					<a class="navbar-brand" href="<?= base_url() ?>">
						...
						<b class="logo-icon">
							...
							<!-- Dark Logo icon -->
							<img src="<?= base_url()?>public/admin/assets/images/logo-icon.png" alt="homepage"
								class="dark-logo" />
							<!-- Light Logo icon -->
							<img src="<?= base_url()?>public/admin/assets/images/logo-light-icon.png" alt="homepage"
								class="light-logo" />
						</b>
						<!--End Logo icon -->
						<!-- Logo text -->
						<span class="logo-text">
							<!-- dark Logo text -->
							<img src="<?= base_url()?>public/admin/assets/images/logo-text.png" alt="homepage"
								class="dark-logo" />
							<!-- Light Logo text -->
							<img src="<?= base_url()?>public/admin/assets/images/logo-light-text.png" class="light-logo"
								alt="homepage" />
						</span>
					</a>
					<!-- ============================================================== -->
					...
					<ul id="sidebarnav">
						...
						<li>
							...
							<div class="user-profile d-flex no-block dropdown m-t-20">
								<div class="user-pic"><img src="<?= base_url()?>public/admin/assets/images/users/1.jpg"
										alt="users" class="rounded-circle" width="40" /></div>
								<div class="user-content hide-menu m-l-10">
									<a href="javascript:void(0)" class="" id="Userdd" role="button"
										data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										<h5 class="m-b-0 user-name font-medium"> <?= $UserLogin->nama ?> <i
						...
						<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<?= base_url() ?>/Admin/berita" aria-expanded="false"><i
									class="fa fa-newspaper"></i><span class="hide-menu">Berita</span></a></li>
						<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<?= base_url() ?>/Admin/pengaduan" aria-expanded="false"><i
									class="fa fa-users"></i><span class="hide-menu">Pengaduan Masyarakat</span></a></li>
						<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<?= base_url() ?>/Admin/sda" aria-expanded="false"><i class="fa fa-leaf"></i><span
									class="hide-menu">Data SDA</span></a></li>
						<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<?= base_url() ?>/Admin/sdm" aria-expanded="false"><i class="fa fa-male"></i><span
									class="hide-menu">Data SDM</span></a></li>
						<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<?= base_url() ?>/Admin/sarana" aria-expanded="false"><i
									class="fa fa-building"></i><span class="hide-menu">Data Sarana Prasarana</span></a>
						</li>
					</ul>
