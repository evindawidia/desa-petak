					...
					<div class="card-body">
						...
						<div class="d-md-flex align-items-center">
							<div>
								...
								<h5 class="card-subtitle">Isikan form dibawah untuk menambah berita</h5>
							</div>
						</div>
						<!-- title -->

						<div class="col-md-12 p-3">
							<?php echo form_open_multipart('Admin/doaddberita');?>
								<div class="row">
									...
									<div class="col-md-9">
										<div class="form-group">
											<label>Judul</label>
											<input type="text" name="judul_berita" value="" class="form-control" required>
										</div>
										<div class="form-group">
											<label>Kategori Berita</label>
											<select name="kat_berita_id" class="form-control" required>
                                                <?php foreach($kat_berita as $kb){ ?>
                                                    <option value="<?= $kb->id_kat_berita ?>"><?= $kb->kat_berita ?></option>
                                                <?php } ?>
											</select>
                                        </div>
                                        <div class="form-group">
											<label>Konten Berita</label>
											<textarea name="content_berita" required></textarea>
                                        </div>
                                        <div class="form-group">
